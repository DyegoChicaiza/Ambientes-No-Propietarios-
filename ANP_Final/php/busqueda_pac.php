...
$user_id=null;
$sql2= "select * from paciente where nombrePaciente like '%$_GET[s]%' or fechaNacimiento like '%$_GET[s]%' or especie like '%$_GET[s]%' or sexo like '%$_GET[s]%' or raza like '%$_GET[s]%' ";
