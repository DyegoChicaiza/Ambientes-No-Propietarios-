...
$user_id=null;
$sql1= "select * from producto where nombreProducto like '%$_GET[s]%' or marcaProducto like '%$_GET[s]%' or fechaRegistro like '%$_GET[s]%' or valorProducto like '%$_GET[s]%' or tipoProducto like '%$_GET[s]%' ";
